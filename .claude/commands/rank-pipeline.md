...
Produce one markdown table with columns: `Company | Industry | Business Model | Fit`. Order rows Fit → Stretch → Out of Reach, alphabetically by company within each tier. After the table:
